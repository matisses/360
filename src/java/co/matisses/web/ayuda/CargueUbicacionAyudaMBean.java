 ...
 */
@ViewScoped
@Named(value = "cargueUbicacionAyudaMBean")
public class CargueUbicacionAyudaMBean implements Serializable {

    private static final Logger log = Logger.getLogger(ColumnasProformaAyudaMBean.class.getSimpleName());
    private List<String[]> mensajes;

    public CargueUbicacionAyudaMBean() {
    ...
    protected void initialize() {
        ...
        mensajes.add(new String[]{"E", "No se encontró saldo de la referencia ####################, para cargar.",
            "La referencia ingresada no se encontró en el sistema.",
            "Verifique la referencia ingresada y continúe."});
        mensajes.add(new String[]{"E", "No se encontró saldo de la referencia ####################, en la ubicación TM.",
            "La referencia que se ingresó no fue encontrada en la ubicación TM.",
        ...
        mensajes.add(new String[]{"I", "Se creó el cargue correctamente.",
